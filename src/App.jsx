    ...
    <div className="min-h-screen p-4 sm:p-8 flex items-center justify-center text-txt antialiased transition-colors duration-300">
      ...
      <div className="max-w-5xl w-full grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
        ...
        >
          ...
          <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-3 gap-5 text-center flex-1 content-start overflow-x-hidden overflow-y-auto max-h-[500px]">
            {/* JavaScript */}
            ...
            <div className="tech-icon flex flex-col items-center gap-2">
              <div className="w-10 h-10 flex items-center justify-center">
                <svg className="w-8 h-8 drop-shadow-md" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M17.5 0L6.5 9.5L2.5 6.5L0 8L6.5 14L0 20L2.5 21.5L6.5 18.5L17.5 28L24 24V4L17.5 0ZM17.5 6L20.5 8.5V19.5L17.5 22L9.5 14L17.5 6Z" fill="#007ACC" />
                </svg>
              </div>
              <span className="text-xs font-medium text-sub">VS Code</span>
            </div>
        ...
        {/* Experience Card */}
        <div
          className="bento-card md:col-span-2 rounded-[2rem] p-6 animate-fade-in flex flex-col"
