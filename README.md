...
[![React](https://img.shields.io/badge/React-Framework-61DAFB?style=for-the-badge&logo=react&logoColor=black)](https://react.dev)
...
- **Profile Photo:** Paste any hosted image URL directly in the dashboard to update your avatar — no code changes needed.
...
2. Log into your Dashboard → **Content Manager** and fill in your own name, bio, social links, experience, projects, and paste your profile photo URL.
3. Everything else — GitHub stats, section visibility, and all displayed text — updates live from the dashboard.
